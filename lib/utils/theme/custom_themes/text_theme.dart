...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.w400, color:Colors.black),
  ...
  static TextTheme darkTextTheme =  TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.w400, color:Colors.white),
